<script>
  ...
  import TenhaControle from "./components/TenhaControle.vue";
  import ResolvaPeloApp from "./components/ResolvaPeloApp.vue";
  import Futuro from "./components/Futuro.vue";
  import BehindThis from "./components/BehindThis.vue";
  import YourSafe from "./components/YourSafe.vue";
  import Investimentos from "./components/Investimentos.vue";
  import CardPaybank from "./components/CardPaybank.vue";
  import AllYouNeed from "./components/AllYouNeed.vue";
  ...
  export default {
    ...
    mounted() {
      /*==================== CALCULADORA DO CDI ====================*/
      let MoneyInvestment =
        document.querySelector(".money-investment").innerText;
      ...
      function scrollHeader() {
        ...
        linksMenu.forEach((item) => {
          if (this.scrollY >= 1000) item.classList.add("link-black");
          else item.classList.remove("link-black");
        });
      }
